...
from custom_components.myrfplayer.const import COMMAND_OFF_LIST, COMMAND_ON_LIST
from custom_components.myrfplayer.device_profiles import (
...
class MyRfPlayerClimate(RfDeviceEntity, ClimateEntity):
