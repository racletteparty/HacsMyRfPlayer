...
from custom_components.myrfplayer.device_profiles import AnyRfpPlatformConfig, RfpLightConfig, RfpPlatformConfig
...
class MyRfPlayerLight(RfDeviceEntity, LightEntity):
